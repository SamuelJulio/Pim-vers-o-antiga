<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastro_veiculo.aspx.cs" Inherits="Flottesoft.App.cadastro_de_veiculos" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="431px">
            ...
            <h2>
                <br/>
                <asp:Label ID="Label1" runat="server" Text="Selecionar tipo de veículo"></asp:Label>
            </h2>
